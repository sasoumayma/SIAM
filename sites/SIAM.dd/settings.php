 ...
 * @endcode
 */
$settings['hash_salt'] = 'ZhTZa3w14OE49lu8Gh-BO-ua1qh8uq6vmtQ2UEFjASsR7xP1UmWbuthdKabonO9LEVH9tXEtbw';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_SIAM_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_SIAM_dd.inc';
}
// </DDSETTINGS>
